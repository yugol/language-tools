...
import impiegato.engine.tests.numerali.NumeraliTestData;
...
public class TestSpec implements Comparable<TestSpec> {
    ...
    public TestSpec(final TestCategory category) {
        this.category = category;
        itemsFile = null;
        name = "";
    }

    public TestSpec(final File file) {
        itemsFile = file;
    ...
    public File getResultsFile() {
        ...
        resultsFile = new File(resultsFile, Constants.RESULTS_FOLDER_NAME);
        resultsFile.mkdirs();
    ...
    @Override
    public int compareTo(final TestSpec o) {
    ...
    public TestData getTestData() throws IOException {
        ...
        switch (category) {
        case NUMERALI:
            testData = new NumeraliTestData(this);
            break;
        case VOCABOLARIO:
